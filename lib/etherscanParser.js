...
class EtherscanParser {
    ...
    async getSourceCode(contractAddress) {
        ...
        try {
            ...
            if (!Array.isArray((_b = (_a = response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.result)) {
                throw new Error(`Failed to ${description}. No result array in HTTP data: ${JSON.stringify((_c = response) === null || _c === void 0 ? void 0 : _c.data)}`);
            }
            ...
            throw new verror_1.VError(`Failed to ${description}. HTTP status code ${(_d = err.response) === null || _d === void 0 ? void 0 : _d.status}, status text: ${(_e = err.response) === null || _e === void 0 ? void 0 : _e.statusText}`);
        }
    }
}
