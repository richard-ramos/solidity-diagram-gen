...
exports.parseUmlClassesFromFiles = async (fileOrFolders) => {
...
async function getSolidityFilesFromFolderOrFiles(folderOrFilePaths) {
    let files = [];
...
function getSolidityFilesFromFolderOrFile(folderOrFilePath) {
