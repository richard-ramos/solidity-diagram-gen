...
export declare function writeSVG(svg: any, svgFilename?: string): void;
export declare function writePng(svg: any, pngFilename?: string, outputFormats?: OutputFormats): void;
